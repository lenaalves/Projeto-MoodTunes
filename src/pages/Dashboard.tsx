          ...
          {page === 'diary' && (
            <div className="flex flex-col gap-3">
              {entries[0] && (
                ...
                >
                  {entries[0].cover_url && (
                    <img src={entries[0].cover_url} alt=""
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="rounded-xl overflow-hidden h-36 relative"
                ...
                <div className="absolute inset-0 flex items-end p-4 gap-4">
                  {/* Avatar com upload */}
                  <div
                    className="relative w-16 h-16 rounded-full overflow-hidden border-4 border-[#0f1018] flex-shrink-0 cursor-pointer group"
                  ...
                  <div>
                    ...
                    {profileBio && <p className="text-xs text-gray-500 mt-0.5 italic">{profileBio}</p>}
                  </div>
                </div>
              </div>
              ...
              <div className={cardClass}>
                ...
                <div className="flex items-center gap-4 mb-5 p-4 bg-white/5 rounded-xl border border-white/10">
                  <div
                    className="w-14 h-14 rounded-full overflow-hidden flex-shrink-0 cursor-pointer border-2 border-white/10 hover:border-purple-500 transition"
                    onClick={() => fileInputRef.current?.click()}
                  >
                    {profileAvatar
                      ? <img src={profileAvatar} alt="avatar" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      ...
                      className="text-xs font-medium text-purple-400 hover:text-purple-300 transition disabled:opacity-50"
                    >
                      {uploadingAvatar ? 'Enviando...' : '📷 Escolher foto do dispositivo'}
                    </button>
                  </div>
                </div>
